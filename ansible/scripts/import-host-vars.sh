...
MAIL_FROM=mail_from
SENSINGCLUES_BASE_URL=sensingclues_base_url
SENSINGCLUES_USERNAME=sensingclues_username
SENSINGCLUES_PASSWORD=sensingclues_password
SENSINGCLUES_USER_ID=sensingclues_user_id
