...
def process_revision_directives(context, revision, directives):
    ...
    This hook adds the geoalchemy2 import to migration files when
    PostGIS geography/geometry types are detected.
    """
    if directives[0].upgrade_ops is not None:
        script = directives[0]
        # Check if any operations use geoalchemy2 types
