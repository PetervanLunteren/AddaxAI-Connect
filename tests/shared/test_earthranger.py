...
class TestBuildCameraEvent:
    def test_shape(self):
        ...
        assert event["event_details"]["summary"] == "Battery at 12%"
        assert event["event_details"]["site"] == "Site 4"
