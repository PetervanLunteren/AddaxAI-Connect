...
- [ ] Serve camera reference images through an authenticated endpoint. Nginx serves /reference-images/camera_{id}.jpg without any auth and the ids are guessable integers; a reference image is a photo of the site. Found during the site-scope audit 10 Aug 2026, needs a serving change, not a query filter.
