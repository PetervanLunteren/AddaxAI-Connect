...
- [ ] Would it be a nice idea to have a tiny little heat map on the Explore dashboard? So you get an overview of the species and map would be a good spatial exploration there. Of course it shouldn't replace the inside map, Just a tiny heat map. What do you think? What should be smaller or where should it be placed? 
