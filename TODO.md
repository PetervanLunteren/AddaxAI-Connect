...
- [ ] The label on the thumbnails currently says "X detections". I want the classification labels there. If there are more than one, list them as separate items. And if there are more than 3, do something like "+ 2 more"