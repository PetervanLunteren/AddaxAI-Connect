...
- [ ] We should remove the duplicate rejection! With the current implementation, all images after an SD swap will get refused since the filenaming starts over again (img_001.jpg, img_002.jpg, etc.)
