...
- [ ] All nice that we have moved camera name to sites, and deployments etc. But what do do with existing tags? 

- [ ] And what do do with the filters in de pages etc? What is sensible in the new version? 
