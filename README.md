...
11. **Log in to the frontend**  
    When the deployment finishes, open your `domain_name` in a browser and register using your `superadmin_email`. You will receive a verification email. Click the link to verify your account, then sign in. You're automatically assigned the 'admin' role wtih full control. 
